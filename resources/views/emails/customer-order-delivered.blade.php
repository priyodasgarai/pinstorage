        ...
        <table style="width:100%; margin:0 auto; text-align:left; border:1px solid #d6d6d6;font-size: 15px;border-top: none;font-family: arial, sans-serif; background: #ffe9e9" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td style="padding:20px;">
                    ...
                    <br>
                   <p>
                    Your ORDER ID:{{ $orderAltId }} has been successfully delivered by our deliver agent {{ $agentName }} at " . date("Y/m/d") . ". Please let us know if you have any questions.
                    Thank you for choosing WahTailor!
                   </p>
                    <p>Thank you</p>

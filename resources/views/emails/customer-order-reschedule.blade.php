        ...
        <table style="width:100%; margin:0 auto; text-align:left; border:1px solid #d6d6d6;font-size: 15px;border-top: none;font-family: arial, sans-serif; background: #ffe9e9" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td style="padding:20px;">
                    <p>Dear {{$userName}},</p>
                    <br>
                    <p> your order {{$orderAltId}} for {{$design_id}} successfully rescheduled on DATE for Measurement {{$measurementDate}}.Track the order status at Track My Order in App — Team Wah Tailor.</p>
                                                            <br><br>
                    <p>Thank you</p>

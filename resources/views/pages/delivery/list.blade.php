...
<div class="row wrapper border-bottom white-bg page-heading">
   ...
   <div class="col-sm-8">
      <div class="title-action">
         <a href="{{url('delivery-management/add')}}" class="btn btn-primary"><i class="fa fa-plus"></i>
	        ...
	        <div class="ibox float-e-margins">
	            ...
	            <div class="ibox-content">
	            	<div class="row">
	            		...
	            		<div class="col-md-4">
	            			<div class="form-group">
	            				<input type="text" name="searchTitle" id="searchTitle" class="form-control" placeholder="Search By Delivery Title...">
	            			</div>
	            		</div>
	            		{{-- <div class="col-md-3">
	            			<div class="form-group">
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		var dataTable = $('#deliveryTable').DataTable({
            ...
            searching:  false,
            ajax: {
		        url: baseUrl+'delivery-management/ajax-delivery-table',
		        type:'POST',
		        data: function(data){
		        	if($('#searchTitle').val()!=""){
			...
			buttons: [
			    {
		            extend: 'excelHtml5',
		            text: 'Export Excel ',
		            filename: function () { return 'Delivery List ' + new Date(); },
		            exportOptions: {
		                columns: [0, 1, 2, 3, 4, 5],
		                modifier: {
		                    order: 'current',                       

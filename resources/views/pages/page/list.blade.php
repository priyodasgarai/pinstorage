...
<div class="row wrapper border-bottom white-bg page-heading">
   ...
   <div class="col-sm-8">
      <div class="title-action">
         <a href="{{route('admin.page-management.add')}}" class="btn btn-primary"><i class="fa fa-plus"></i>
          Add Pages
         </a>
      </div>
   </div>
          ...
          <div class="ibox float-e-margins">
              ...
              <div class="ibox-content">
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <input type="text" name="searchTitle" id="searchTitle" class="form-control" placeholder="Search By Name...">
                    </div>
                  </div>
                  {{-- <div class="col-md-3">
                    <div class="form-group">
  ...
  $(document).ready(function() {
    ...
    var dataTable = $('#pageTable').DataTable({
      dom: 'Bfrtip',
            ...
            searching:  false,
            ajax: {
            url: "{{ route('admin.page-management.ajax-table') }}",
            type:'POST',
            data: function(data){
              if($('#searchTitle').val()!=""){

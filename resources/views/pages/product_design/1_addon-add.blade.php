                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              <label>Group<sup>*</sup></label>
                                 <input type="text" placeholder="Enter Group" data-check="Group" name="input_group" id="input_group"  class="form-control requiredCheck" value="">
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              <label>Custom Price<sup>*</sup></label>
                                 <input type="text"  name="custom_price" id="custom_price"  class="form-control checkDecimal requiredCheck" data-check="Custom Price">
                            </div>
                          </div>
                        </div>

                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Enter Coupon Code" data-check="Coupon Code" name="coupon_code" id="coupon_code" class="form-control requiredCheck" value="{{isset($data)?$data->coupon_code:''}}">
                                </div>
                            </div>
                            <div class="col-md-6">
                              <div class="form-group">
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                                    ...
                                    <input type="number" placeholder="Enter Usage Per User" data-check="Usage Per User" name="usage_limit_per_user" id="usage_limit_per_user" class="form-control requiredCheck" value="{{isset($data)?$data->usage_limit_per_user:''}}" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*?)\..*/g, '$1');">
                            </div>

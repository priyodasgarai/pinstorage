                          ...
                          <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                  ...
                                  <select class="form-control requiredCheck" name="state_id" id="state_id" data-check="State">
                                    <option value="">-Choose State-</option>
                                    @if(count($stateList)>0)
                                      @foreach ($stateList as $key => $value)
                                      <option value="{{$value->st_id}}" {{(isset($data) && $data->state_id == $value->st_id)?'selected':''}}>
                                        {{$value->state_name}}
                                      </option>  
                                        @endforeach
                                      @else
                                  ...
                                  <select class="form-control requiredCheck" name="city_id" id="city_id" data-check="City">
                                    <option value="">-Choose City-</option>
                                     @if(count($cityList)>0)
                                      ...
                                      <option value="{{$value->ct_id}}" {{(isset($data) && $data->city_id == $value->ct_id)?'selected':''}}>
                                      {{$value->citi_name}}
                                      </option>  
                                       @endforeach
                                      @else
